...
export default function BoardList() {
  ...
  return (
    <div className='mb-20 flex w-full px-5'>
      <div className='flex w-full flex-col justify-start gap-4 self-stretch rounded-2xl bg-white py-4'>
        <Search
          keyword={keyword}
          ...
          endDate={endDate}
        />
        <div className='flex w-full flex-col justify-start gap-4 self-stretch rounded-2xl bg-white py-4 shadow-[0px_0px_20px_0px_rgba(0,0,0,0.08)]'>
